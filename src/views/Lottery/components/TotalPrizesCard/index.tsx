...
import { Heading, Card, CardBody, CardFooter, Text, LogoIcon, Flex } from '@shrimpswap/uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeDollarAmount = shrimpPriceUsd.times(new BigNumber(lotteryPrizeAmount))
      ...
      <CardBody>
        {account && (
          <Flex mb="16px" alignItems="center" justifyContent="space-between" style={{ height: '20px' }}>
            {currentLotteryNumber >= 0 && (
              <>
                <Text fontSize="12px" style={{ fontWeight: 600 }}>{`Shrimpy Round #${currentLotteryNumber}`}</Text>
              </>
            )}
          </Flex>
        )}
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} SHRIMP</Heading>
