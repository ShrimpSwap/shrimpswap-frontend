# Contributing to the ShrimpSwap ecosystem 🧂

Thank you for taking the time to contribute!

You can start by reading our [Contribution guidelines](https://docs.shrimpswap.finance/code/contributing) first.
...
```
TranslateString(675, `You have ${shrimpBalance} left in your wallet`, { num: shrimpBalance })
```
